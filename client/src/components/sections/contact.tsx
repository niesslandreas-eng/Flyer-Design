        ...
        <div className="container px-4">
          <div className="grid grid-cols-1 gap-12 items-center">
            <div className="text-center">
              ...
              <div className="flex flex-col items-center gap-4">
                <a
                  ...
                  className="w-full max-w-xs flex flex-col items-center gap-3 p-6 rounded-xl bg-white/5 hover:bg-white/10 transition-colors group text-center"
                >
                  ...
                  <p className="text-lg font-bold font-mono">0152-33673977</p>
                </a>
                ...
                >
                  ...
                  <p className="text-lg font-bold font-mono">@mellas.kreativwerkstatt</p>
                </a>
              </div>
            </div>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-card p-8 rounded-3xl border border-white/10 text-center space-y-6 block cursor-pointer group max-w-md mx-auto w-full"
            >
