  ...
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      if (window.jotformEmbedHandler) {
        // @ts-ignore
        window.jotformEmbedHandler("iframe[id='JotFormIFrame-260761996481066']", "https://form.jotform.com/");
      }
    };
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center py-12 px-4">
      ...
      <Card className="max-w-4xl w-full shadow-lg border-none overflow-hidden bg-white min-h-[600px] flex flex-col">
        <CardContent className="p-0 relative flex-grow flex flex-col">
          ...
          <iframe
            id="JotFormIFrame-260761996481066"
            title="Einverständniserklärung"
            onLoad={() => {
              console.log("Iframe loaded");
              setLoading(false);
            }}
            src="https://form.jotform.com/260761996481066"
            style={{
              width: "100%",
